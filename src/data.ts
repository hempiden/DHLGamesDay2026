...
export const INITIAL_MATCHES: Match[] = [
  ...
  },
  {
    ...
    team_a: '[{"id":"lane-1","name":"សុខ ដារ៉ា (Sok Dara)"},{"id":"lane-2","name":"គង់ ចាន់ត្រា (Kong Chantra)"},{"id":"lane-3","name":"លី ម៉េងហួរ (Ly Menghour)"}]',
    team_b: '{"start_time":null,"is_running":false,"times":{}}',
    score_a: 0,
    score_b: 0,
    status: 'Upcoming',
    created_at: new Date(Date.now() + 3600000).toISOString(),
